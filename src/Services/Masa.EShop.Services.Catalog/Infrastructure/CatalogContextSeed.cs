...
public class CatalogContextSeed
{
    public async Task SeedAsync(CatalogDbContext context,
        ...
        IOptions<CatalogContextSeedOptions> options,
        ILogger<CatalogContextSeed> logger)
    {
        var useCustomData = options.Value.UseCustomData;
        var contentRootPath = env.ContentRootPath;
        var picturePath = env.WebRootPath;

        if (!context.CatalogBrands.Any())
        {
            await context.CatalogBrands.AddRangeAsync(useCustomData
        ...
        {
            await context.CatalogTypes.AddRangeAsync(useCustomData
        ...
        {
            await context.CatalogItems.AddRangeAsync(useCustomData
