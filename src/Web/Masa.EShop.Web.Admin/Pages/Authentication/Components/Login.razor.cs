using Masa.EShop.Web.Admin.Data.Shared.Login;

namespace Masa.EShop.Web.Admin.Pages.Authentication.Components
{
    public partial class Login
    {
        ...
        [Parameter]
        public EventCallback<LoginDto> OnLogin { get; set; }
